...
def server(address):
    ...
    sock.bind(address)
    sock.listen(1)
    print('Running this script in anthor window with "-c" to connect')
...
def client(address):
    ...
    put_block(sock, b'Explicit is better than umplicit.')
    put_block(sock, b'Simple si better than complex.')
    put_block(sock, b'')
    sock.close()


if __name__ == '__main__':
    parser = ArgumentParser(description='Transimit & receive blocks over TCP')
