...
def client(host, port, bytecount):
    sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    # round up to a mulitple of 16
    bytecount = (bytecount + 15) // 16 * 16
    # 16-byte message to repeat over and over
...
if __name__ == '__main__':
    ...
    parser.add_argument('bytecount', type=int, nargs='?', default=16,
                        help='number of types for client to send (default 16)')
